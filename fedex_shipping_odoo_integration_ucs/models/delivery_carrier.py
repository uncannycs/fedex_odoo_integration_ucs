...
class DeliveryCarrier(models.Model):
    ...
    delivery_type = fields.Selection(selection_add=[('fdx_delivery', 'Fedex')],
    ...
    fdx_default_package_type_id = fields.Many2one('stock.package.type', string="Default Package Type")
    ...
    fdx_use_onerate = fields.Boolean("Want To Use FedEx OneRate Service?", default=False)
    fdx_cod = fields.Boolean('COD')
    fdx_require_signature = fields.Boolean(string="Signature")
    fdx_signature_type = fields.Selection([('INDIRECT', 'INDIRECT'),
                                          ('DIRECT', 'DIRECT'),
                                          ('ADULT', 'ADULT')], string="Signature Options")
    fdx_insurance = fields.Boolean(string="Insured Request",
